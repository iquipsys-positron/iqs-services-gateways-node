...
export interface IGatewaysController {
    ...
    getGatewayById(correlationId: string, gateway_id: string, 
        callback: (err: any, gateway: GatewayV1) => void): void;

    getGatewayByUdi(correlationId: string, gateway_udi: string, 
        callback: (err: any, gateway: GatewayV1) => void): void;
    ...
    deleteGatewayById(correlationId: string, gateway_id: string,
        callback: (err: any, gateway: GatewayV1) => void): void;
